...
const ReviewCard = (props) => {
  ...
  return (
    <div className={`review-card ${darkMode ? "dark-mode-card" : "light-mode-card"}`}>
      <img src={props.img} alt={props.name} className="review-card__profile-pic" />
      <div className={`review-card__name ${darkMode ? "dark-mode__color1" : "light-mode__color1"}`}>{props.name}</div>
      <div className={`review-card__designation ${darkMode ? "dark-mode__color2" : "light-mode__color2"}`}>
        {props.designation}
      </div>
      ...
      <div className={`review-card__review ${darkMode ? "dark-mode__color2" : "light-mode__color2"}`}>{props.review}</div>
    </div>
  )
}
